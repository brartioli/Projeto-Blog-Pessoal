...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		...
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L,"Bruna", "bruna@email.com", "12345678", "-"));
	...
	public void deveAtualizarUmUsuario() {
		Optional<Usuario> usuarioCadastrado = usuarioService.cadastrarUsuario(new Usuario(0L,"Juliana Flores", "julianaflores@email.com", "juliana123", "-"));
		
		Usuario usuarioUpdate = new Usuario(usuarioCadastrado.get().getId(), "Juliana Flores Santos", "julianaflores@email.com", "juliana123", "-" );
	...
	public void deveMostrarTodosOsUsuarios() {
		usuarioService.cadastrarUsuario(new Usuario (0L, "Sabrina Carpenter", "sabrinacarpenter@email.com", "sabrina123", "-"));
		
		usuarioService.cadastrarUsuario(new Usuario (0L, "Ricardo Souza", "ricardosouza@email.com", "ricardo123", "-"));
